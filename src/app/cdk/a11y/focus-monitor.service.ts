...
import { Platform, supportsPassiveEventListeners } from '@app/cdk/platform';
...
export function FOCUS_MONITOR_PROVIDER_SERVICE_FACTORY(
	parentDispatcher: FocusMonitorService, ngZone: NgZone, platform: Platform) {
	return parentDispatcher || new FocusMonitorService(ngZone, platform);
}

export const FOCUS_MONITOR_SERVICE_PROVIDER = {
	// If there is already a FocusMonitor available, use that. Otherwise, provide a new one.
	provide: FocusMonitorService,
	deps: [[new Optional(), new SkipSelf(), FocusMonitorService], NgZone, Platform],
	useFactory: FOCUS_MONITOR_PROVIDER_SERVICE_FACTORY
};
