...
export const CONNECTED_OVERLAY_SCROLL_STRATEGY = new InjectionToken<() => ScrollStrategy>('connected-overlay-scroll-strategy');



export function CONNECTED_OVERLAY_SCROLL_STRATEGY_PROVIDER_FACTORY(overlayService: OverlayService):
...
export class ConnectedOverlayDirective implements OnDestroy, OnChanges {
	...
	@Input('appConnectedOverlayOrigin') origin: OverlayOriginDirective;

	/** Registered connected position pairs. */
	@Input('appConnectedOverlayPositions') positions: ConnectionPositionPair[];

	/** The offset in pixels for the overlay connection point on the x-axis */
	@Input('appConnectedOverlayOffsetX')
	...
	@Input('appConnectedOverlayOffsetY')
	...
	@Input('appConnectedOverlayWidth') width: number | string;

	/** The height of the overlay panel. */
	@Input('appConnectedOverlayHeight') height: number | string;

	/** The min width of the overlay panel. */
	@Input('appConnectedOverlayMinWidth') minWidth: number | string;

	/** The min height of the overlay panel. */
	@Input('appConnectedOverlayMinHeight') minHeight: number | string;

	/** The custom class to be set on the backdrop element. */
	@Input('appConnectedOverlayBackdropClass') backdropClass: string;

	/** Strategy to be used when handling scroll events while the overlay is open. */
	@Input('appConnectedOverlayScrollStrategy') scrollStrategy: ScrollStrategy =
		this._scrollStrategy();

	/** Whether the overlay is open. */
	@Input('appConnectedOverlayOpen') open: boolean = false;

	/** Whether or not the overlay should attach a backdrop. */
	@Input('appConnectedOverlayHasBackdrop')
	...
	constructor (
		...
		@Inject(CONNECTED_OVERLAY_SCROLL_STRATEGY) private _scrollStrategy) {
