...
import { ScrollableDirective } from '@app/cdk/scrolling';
...
export class ConnectedPositionStrategy implements PositionStrategy {
	...
	attach(overlayRef: OverlayRef): void {
		...
		this._resizeSubscription = this._viewportService.change().subscribe(() => this.apply());
	}
	 ...
	 */
	withScrollableContainers(scrollables: ScrollableDirective[]) {
