...
export class CalendarComponent<D> implements AfterContentInit, OnDestroy, OnChanges {
	...
	@ViewChild(YearViewComponent) yearView: YearViewComponent<D>;
	...
	constructor (private _elementRef: ElementRef,
		private _intl: DatepickerIntlService,
		private _ngZone: NgZone,
		@Optional() private _dateAdapter: DateAdapter<D>,
		@Optional() @Inject(DATE_FORMAT) private _dateFormats: DateFormat,
		...
		if (!this._dateFormats) {
			throw DatepickerErrorFactory.createMissingDateImplError('DATE_FORMATS');
		}
