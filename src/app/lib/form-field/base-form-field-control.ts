...
export abstract class BaseFormFieldControl<T> {
	...
	/**
	 * An optional name for the control type that can be used to distinguish `app-form-field` elements
	 * based on their control type. The form field will add a class,
	 * `app-form-field-type-{{controlType}}` to its root element.
	 */
