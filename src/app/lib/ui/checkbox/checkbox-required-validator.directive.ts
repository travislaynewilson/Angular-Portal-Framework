...
export const _AppCheckboxRequiredValidator = CheckboxRequiredValidator;
...
export class CheckboxRequiredValidatorDirective extends _AppCheckboxRequiredValidator { }
