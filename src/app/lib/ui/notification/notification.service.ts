...
import {OverlayService, OverlayConfig, OverlayRef} from '@app/core/overlay';
import {ComponentPortal, ComponentType, PortalInjector} from '@app/core/portal';
...
import {BreakpointObserver, Breakpoints} from '@app/core/layout';
